...
<body>
  ...
  <div style="background-color: #E8E8E8;">
    ...
    <!-- 임시 공백 -->
    <div class="vh-20 d block d-lg-none d-xl-none">
    </div>
    <div class="vh-75 d-block d-md-none d-lg-none">
    </div>
  </div>
